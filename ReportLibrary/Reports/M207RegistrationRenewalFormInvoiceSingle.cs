...
namespace ReportLibrary
{
    ...
    public partial class M207RegistrationRenewalFormInvoiceSingle : Telerik.Reporting.Report, IHaveConnectionString
    {
        public M207RegistrationRenewalFormInvoiceSingle()
        {
            InitializeComponent();
        }
