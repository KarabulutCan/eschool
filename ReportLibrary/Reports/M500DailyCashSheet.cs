...
namespace ReportLibrary
{
    ...
    public partial class M500DailyCashSheet : Telerik.Reporting.Report, IHaveConnectionString
    {
        public M500DailyCashSheet()
        {
            InitializeComponent();
        }
        public void SetConnectionString(string schoolCode)
        {
            ...
            this.sqlDataSource11.ConnectionString = connectionString;
