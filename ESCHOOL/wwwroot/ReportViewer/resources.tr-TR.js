(function (trv, $) {
    ...
    var sr = {
        ...
        parameterEditorSelectNone: 'seçimi temizle',
        parameterEditorSelectAll: 'hepsini seç',
        parametersAreaPreviewButton: 'Ön izleme',

        menuNavigateBackwardText: 'Geri Git',
        menuNavigateBackwardTitle: 'Geri Git',
        menuNavigateForwardText: 'İleri Git',
        menuNavigateForwardTitle: 'İleri Git',
        menuStopRenderingText: 'Oluşturmayı Durdur',
        menuStopRenderingTitle: 'Oluşturmayı Durdur',
        menuRefreshText: 'Yenile',
        menuRefreshTitle: 'Yenile',
        menuFirstPageText: 'İlk sayfa',
        menuFirstPageTitle: 'İlk sayfa',
        menuLastPageText: 'Son Sayfa',
        menuLastPageTitle: 'Son Sayfa',
        menuPreviousPageTitle: 'Önceki sayfa',
        menuNextPageTitle: 'Sonraki Sayfa',
        menuPageNumberTitle: 'Sayfa Numarası Seçici',
        menuDocumentMapTitle: 'Belge Haritasını Aç/Kapat',
        menuParametersAreaTitle: 'Parametre Alanını Aç/Kapat',
        menuZoomInTitle: 'Yakınlaştır',
        menuZoomOutTitle: 'Uzaklaştır',
        menuPageStateTitle: 'Tam Sayfa/Sayfa Genişliği arasında geçiş yap',
        menuPrintText: 'Yazdır...',
        menuContinuousScrollText: 'Sürekli Kaydırmayı Aç/Kapat',
        menuSendMailText: 'e-posta gönder',
        menuPrintTitle: 'Yazdır',
        menuContinuousScrollTitle: 'Sürekli Kaydırmayı Aç/Kapat',
        menuSendMailTitle: 'e-posta gönder',
        exitTitle: 'Çıkış',
        menuExportText: 'Dışa aktar',
        menuExportTitle: 'Dışa aktar',
        menuPrintPreviewText: 'Baskı Önizlemeyi Aç/Kapat',
        menuPrintPreviewTitle: 'Baskı Önizlemeyi Aç/Kapat',
        menuSearchText: 'Arama',
        menuSearchTitle: 'Aramayı Aç/Kapat',
        menuSideMenuTitle: 'Yan Menüyü Aç/Kapat',
        ...
        searchDialogTitle: 'Rapor içeriğinde ara',
        searchDialogSearchInProgress: "searching...",
        searchDialogNoResultsLabel: "No results",
        searchDialogResultsFormatLabel: "Result {0} of {1}",
        searchDialogStopTitle: 'Aramayı Durdur',
        searchDialogNavigateUpTitle: 'Yukarı Git',
        searchDialogNavigateDownTitle: 'Aşağı Git',
        searchDialogMatchCaseTitle: 'Eşleşme',
        searchDialogMatchWholeWordTitle: 'Tüm kelimeyi eşleştir',
        searchDialogUseRegexTitle: 'Normal İfadeyi Kullan',
        searchDialogCaptionText: 'Bul',
        searchDialogPageText: 'sayfa',
        // Send Email dialog resources
        sendEmailDialogTitle: "Eposta gönder",
